...
pub use proto::{
    ...
    TokenReuseError, Transmit, TransportConfig, TransportErrorCode, UdpStats,
    ValidationTokenMemoryCache, ValidationTokenStore, VarInt, VarIntBoundsExceeded, Written,
};
